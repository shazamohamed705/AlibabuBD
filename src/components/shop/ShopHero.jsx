...
export default function ShopHero() {
  ...
  if (loading) {
    return (
      <section className="animate-pulse relative w-full overflow-hidden" style={{ height: 'clamp(400px, 40vw, 650px)', paddingTop: '80px', background: '#1a1612' }}>
  ...
  return (
    <section
      ...
      style={{ height: 'clamp(400px, 40vw, 650px)', paddingTop: '80px' }}
    >
      <style>{`
      ...
      {/* Background */}
      <img
        src={banner?.img || '/1434f26e4733da9c5dd02b6ca6a480b57186196d.png'}
        alt={banner?.title || 'Shop'}
        className="absolute inset-0 w-full h-full object-cover"
        style={{ objectPosition: 'center center' }}
        onError={e => { e.target.src = '/1434f26e4733da9c5dd02b6ca6a480b57186196d.png'; }}
      />
